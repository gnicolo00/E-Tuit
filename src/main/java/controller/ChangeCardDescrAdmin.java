...
@WebServlet(name = "ChangeCardDescriptionAdmin", value = "/change-card-descr-admin")
public class ChangeCardDescrAdmin extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        String userEmail = request.getParameter("changeCardDescrEmail");
        boolean validEmail = true;
        String newCardDescription = request.getParameter("newCardAdminDescription");
